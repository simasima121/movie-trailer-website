import fresh_tomatoes   #importing fresh_tomatoes.py so can use open_movies_page function and structures html page
import media            #import media so can create instances of Movie 
...
ratatouille = media.Movie("Ratatouilee",
...
#calling open_movies_page from fresh_tomatoes.py with argument movies - takes array of values, this opens up html page and produces movies
